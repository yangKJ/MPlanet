...
public struct Constant {
    ...
    public static let safeAreaEdgeInsets: UIEdgeInsets = {
        if #available(iOS 11.0, *) {
            return Constant.keyWindow?.safeAreaInsets ?? UIEdgeInsets.zero
        } else {
    ...
    public static let isIphoneX: Bool = {
        ...
        if let bottomHeight = Constant.keyWindow?.safeAreaInsets.bottom {
    ...
    public static var topViewController: UIViewController? {
        var vc = Constant.keyWindow?.rootViewController
