...
extension Reactive where Base: UIViewController {
    ...
    public func pushViewControllerAndReplace(_ viewController: @escaping @autoclosure () -> UIViewController,
                                             ...
                                             animated: Bool = true) -> Binder<Void> {
        return Binder(base) { this, _ in
            this.navigationController?.fy.pushViewControllerAndReplace(viewController(), replaceCount: replaceCount, animated: animated)
        }
    }
    ...
    public func pushViewController(_ viewController: @escaping @autoclosure () -> UIViewController,
                                   ...
                                   animated: Bool = true) -> Binder<Void> {
        return Binder(base) { this, _ in
            this.navigationController?.fy.pushViewController(viewController(), removeType: removeType, animated: animated)
        }
    }
    ...
    public func pushViewController(_ viewController: @escaping @autoclosure () -> UIViewController,
                                   ...
                                   animated: Bool = true) -> Binder<Void> {
        return Binder(base) { this, _ in
            this.navigationController?.fy.pushViewController(viewController(), removeTypes: removeTypes, animated: animated)
        }
    }
